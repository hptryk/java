...
class Slip14
{
    ...
    public static void main(String[] args) 
    {
        ...
        if (files != null) 
        {
            for (File file : files) 
            {
                if (file.isFile() && file.getName().endsWith("t1.txt")) 
                {
...
//create a text file eg t1.txt
*/

/*
//create example folder in that ->> slip14.html
<html>
<body>
...
//in same example folder create ->> slip14.jsp
